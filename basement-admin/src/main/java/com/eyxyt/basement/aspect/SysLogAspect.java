package com.eyxyt.basement.aspect;
...
import com.eyxyt.basement.utils.IPUtils;
...
public class SysLogAspect {
    ...
    @Pointcut("@annotation(com.eyxyt.basement.annotation.SysLog)")
